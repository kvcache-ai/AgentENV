...
const (
	...
	Scheduler_GetFleetPlan_FullMethodName       = "/scheduler.v1.Scheduler/GetFleetPlan"
	Scheduler_CordonNode_FullMethodName         = "/scheduler.v1.Scheduler/CordonNode"
	Scheduler_UncordonNode_FullMethodName       = "/scheduler.v1.Scheduler/UncordonNode"
)
...
type SchedulerClient interface {
	...
	GetFleetPlan(ctx context.Context, in *GetFleetPlanRequest, opts ...grpc.CallOption) (*GetFleetPlanResponse, error)
...
func (c *schedulerClient) GetFleetPlan(ctx context.Context, in *GetFleetPlanRequest, opts ...grpc.CallOption) (*GetFleetPlanResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFleetPlanResponse)
	err := c.cc.Invoke(ctx, Scheduler_GetFleetPlan_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schedulerClient) CordonNode(ctx context.Context, in *CordonNodeRequest, opts ...grpc.CallOption) (*CordonNodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CordonNodeResponse)
	err := c.cc.Invoke(ctx, Scheduler_CordonNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schedulerClient) UncordonNode(ctx context.Context, in *UncordonNodeRequest, opts ...grpc.CallOption) (*UncordonNodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UncordonNodeResponse)
	err := c.cc.Invoke(ctx, Scheduler_UncordonNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SchedulerServer interface {
	...
	GetFleetPlan(context.Context, *GetFleetPlanRequest) (*GetFleetPlanResponse, error)
...
func (UnimplementedSchedulerServer) LookupNode(context.Context, *LookupNodeRequest) (*LookupNodeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LookupNode not implemented")
}
func (UnimplementedSchedulerServer) RecordAssignment(context.Context, *RecordAssignmentRequest) (*RecordAssignmentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RecordAssignment not implemented")
}
...
func (UnimplementedSchedulerServer) ReportSandboxEvent(context.Context, *ReportSandboxEventRequest) (*ReportSandboxEventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportSandboxEvent not implemented")
}
func (UnimplementedSchedulerServer) ListObservedNodes(context.Context, *ListObservedNodesRequest) (*ListObservedNodesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListObservedNodes not implemented")
}
func (UnimplementedSchedulerServer) ListP2PPeers(context.Context, *ListP2PPeersRequest) (*ListP2PPeersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListP2PPeers not implemented")
}
func (UnimplementedSchedulerServer) RecordP2PArtifact(context.Context, *RecordP2PArtifactRequest) (*RecordP2PArtifactResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RecordP2PArtifact not implemented")
}
func (UnimplementedSchedulerServer) ForgetP2PArtifact(context.Context, *ForgetP2PArtifactRequest) (*ForgetP2PArtifactResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ForgetP2PArtifact not implemented")
}
func (UnimplementedSchedulerServer) LookupP2PArtifact(context.Context, *LookupP2PArtifactRequest) (*LookupP2PArtifactResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LookupP2PArtifact not implemented")
}
...
func (UnimplementedSchedulerServer) GetFleetPlan(context.Context, *GetFleetPlanRequest) (*GetFleetPlanResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFleetPlan not implemented")
}
func (UnimplementedSchedulerServer) CordonNode(context.Context, *CordonNodeRequest) (*CordonNodeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CordonNode not implemented")
}
func (UnimplementedSchedulerServer) UncordonNode(context.Context, *UncordonNodeRequest) (*UncordonNodeResponse, error) {
...
func _Scheduler_GetFleetPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFleetPlanRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SchedulerServer).GetFleetPlan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Scheduler_GetFleetPlan_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchedulerServer).GetFleetPlan(ctx, req.(*GetFleetPlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Scheduler_CordonNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CordonNodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SchedulerServer).CordonNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Scheduler_CordonNode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchedulerServer).CordonNode(ctx, req.(*CordonNodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Scheduler_UncordonNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UncordonNodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SchedulerServer).UncordonNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Scheduler_UncordonNode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchedulerServer).UncordonNode(ctx, req.(*UncordonNodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Scheduler_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetFleetPlan",
			Handler:    _Scheduler_GetFleetPlan_Handler,
		},
		{
			MethodName: "CordonNode",
			Handler:    _Scheduler_CordonNode_Handler,
		},
		{
			MethodName: "UncordonNode",
			Handler:    _Scheduler_UncordonNode_Handler,
		},
	},
